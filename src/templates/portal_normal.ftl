		...
		<div class="d-flex flex-column flex-fill" id="wrapper">
			<#if show_header>
				...
				<!--<div class="navbar navbar-classic navbar-top py-3">
						<div class="container user-personal-bar">
							<div class="align-items-center autofit-row">
								<a id="logo"
									...
									href="${site_default_url}" title="<@liferay.language_format arguments="" key="
									go-to-x" />">
								<img alt="${logo_description}" class="mr-2" height="56" src="${site_logo}" />
								<#if show_site_name>
									<h1 id="nombreSitio" class="mb-0" role="heading" aria-level="1"><b>Sistema de
										</b>Auditoría Interna</h1>
								</#if>
								</a>
					...
					<div class="navbar navbar-classic navbar-expand-md navbar-light py-1" id="menu">
